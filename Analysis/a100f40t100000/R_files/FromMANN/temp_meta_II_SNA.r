#temp_meta_II_SNA.r
#USED THIS TO DO MORE DETAILED ANALYSIS--OF MORE RUNS--OF THE NETWORKS AND TO TEST THE USE OF NEW STATISTICS
#GEN 11-17-15
...
for(i in 0:9){
    ...
    setwd(paste("a000250_r",a,"/output/",sep=""))
    ...
    for(j in 0:99){ #j is tick number; i
        ...
        png(paste("../../MetaGraphs/Net_Run",i,"_Tick_",b,".png",sep=""))
